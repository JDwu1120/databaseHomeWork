                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-hover">
                        ...
                        <tr>
                            ...
                            <td><a href="deleteChose?classNum={{ $user->classNum }}&studentNum={{ $user->studentNum }}">删除</a></td>
                        </tr>
                        @endforeach
                        </tbody>
                        <form action="searchChoseInfo" method="post">{{ csrf_field() }}
